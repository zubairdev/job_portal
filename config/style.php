<link rel="stylesheet" media="all" href="<?php echo url_for('/stylesheet/bootstrap.min.css'); ?>" />
<link rel="stylesheet" media="all" href="<?php echo url_for('/stylesheet/flexslider.css'); ?>" />
